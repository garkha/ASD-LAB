                        ...
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                ...
                                <tr>
                                    <td>BLEEDING TIME</td>
                                    <td>
                                        <input type="text" name="BLEEDING_TIME" id="BLEEDING_TIME" value="{{old('BLEEDING_TIME')}}" placeholder="00 MIN 00 SEC">
                                ...
                                <tr>
                                    <td>CLOTTING TIME</td>
                                    <td>
                                        <input type="text" name="CLOTTING_TIME" id="CLOTTING_TIME" value="{{old('CLOTTING_TIME')}}" placeholder="00 MIN 00 SEC">
