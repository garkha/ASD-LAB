                ...
                <div class='row mt-5'>
                    <div class='info-box' style='padding: 20px; overflow-x:auto;'>
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                <tr>
                                    <th>Test Name<p></p>COMPLETE BLOOD COUNT (CBC)</th>
                                    <th>Result</th>
                                    <th>Unit</th>
                                ...
                                <tr>
                                    <td>Haemoglobin</td>
                                    <td>
                                        <input type="number" step="any" name="Haemoglobin" id="Haemoglobin" value="{{$test->HAEMOGLOBIN}}">
                                ...
                                <tr>
                                  <td>RBC</td>
                                  <td>
                                      <input type="number" step="any" name="RBC" id="RBC" value="{{$test->RBC}}">
                              ...
                              <tr>
                                  <td>HCT</td>
                                  <td>
                                      <input type="number" step="any" name="HCT" id="HCT" value="{{$test->HCt}}">
                              ...
                              <tr>
                                  <td>MCV</td>
                                  <td>
                                      <input type="number" step="any" name="MCV" id="MCV" value="{{$test->MCV}}">
                              ...
                              <tr>
                                  <td>MCH</td>
                                  <td>
                                      <input type="number" step="any" name="MCH" id="MCH" value="{{$test->MCH}}">
                              ...
                              <tr>
                                  <td>MCHC</td>
                                  <td>
                                      <input type="number" step="any" name="MCHC" id="MCHC" value="{{$test->MCHC}}">
                              ...
                              <tr>
                                  <td>RDW- SD</td>
                                  <td>
                                      <input type="number" step="any" name="RDWSD" id="RDWSD" value="{{$test->RDW_SD}}">
                              ...
                              <tr>
                                  <td>RDW- CV</td>
                                  <td>
                                      <input type="number" step="any" name="RDWCV" id="RDWCV" value="{{$test->RDW_CV}}">
                            ...
                            <table id="test">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="TLC" id="TLC" value="{{$test->TLC}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="Platelet" id="Platelet" value="{{$test->PLATELET_COUNT}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="ESR" id="ESR" value="{{$test->ESR}}">
                            ...
                            <table id="test">
                                ...
                                <tr>
                                    <td>Neutrophil</td>
                                    <td>
                                        <input type="number" step="any" name="Neutrophil" id="Neutrophil" value="{{$test->Neutrophil}}">
                                ...
                                <tr>
                                    <td>Lymphocytes</td>
                                    <td>
                                        <input type="number" step="any" name="Lymphocytes" id="Lymphocytes" value="{{$test->Lymphocytes}}">
                                ...
                                <tr>
                                    <td>Eosinophils</td>
                                    <td>
                                        <input type="number" step="any" name="Eosinophils" id="Eosinophils" value="{{$test->Eosinophils}}">
                                ...
                                <tr>
                                    <td>Monocytes</td>
                                    <td>
                                        <input type="number" step="any" name="Monocytes" id="Monocytes" value="{{$test->Monocytes}}">
                                ...
                                <tr>
                                    <td>Basophils</td>
                                    <td>
                                        <input type="number" step="any" name="Basophils" id="Basophils" value="{{$test->Basophils}}">
                            ...
                            <table id="test">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="ANC" id="ANC" value="{{$test->ANC}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="ALC" id="ALC" value="{{$test->ALC}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="AEC" id="AEC" value="{{$test->AEC}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="AMC" id="AMC" value="{{$test->AMC}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="ABC" id="ABC" value="{{$test->ABC}}">
                            ...
                            <table id="test">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="number" step="any" name="NLR" id="NLR" value="{{$test->NLR}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="number" step="any" name="LMR" id="LMR" value="{{$test->LMR}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="number" step="any" name="PLR" id="PLR" value="{{$test->PLR}}">
                            ...
                            <table id="test">
                                ...
                                <tr>
                                    <td>MPV</td>
                                    <td>
                                    <input type="number" step="any" name="MPV" id="MPV" value="{{$test->MPV}}">
                                ...
                                <tr>
                                    <td>PCT</td>
                                    <td>
                                    <input type="number" step="any" name="PCT" id="PCT" value="{{$test->PCT}}">
                                ...
                                <tr>
                                    <td>PDW</td>
                                    <td>
                                    <input type="number" step="any" name="PDW" id="PDW" value="{{$test->PDW}}">
