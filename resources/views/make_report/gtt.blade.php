                        ...
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <input type="number" step="any" name="bs_fasting" id="bs_fasting" value="{{old('bs_fasting')}}"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <input type="number" step="any" name="bs_after_one_hour" id="bs_after_one_hour" value="{{old('bs_after_one_hour')}}"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <input type="number" step="any" name="bs_after_two_hour" id="bs_after_two_hour" value="{{old('bs_after_two_hour')}}"/>
