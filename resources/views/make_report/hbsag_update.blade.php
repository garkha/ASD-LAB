                ...
                <div class='row mt-5'>
                    <div class='info-box' style='padding: 20px; overflow-x:auto;'>
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                <tr>
                                    <th>Test Name<p></p>HBSAG (RAPID)</th>
                                    <th>Result</th>
                                    <th>Unit</th>
                                ...
                                <tr>
                                    <td>HBSAG (Rapid)</td>
                                    <td>
                                        <select name="hbsag" class="form-select form-select-sm">
                                            <option value="{{$test->hbsag}}" selected>{{$test->hbsag}}</option>
