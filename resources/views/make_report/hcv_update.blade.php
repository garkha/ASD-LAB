@extends('layout.asd')
@section('title','HEPATITIS C VIRUS (HCV RAPID)')
@section('head-script')
@endsection
@section('style')
    <style>
                ...
                <div class='row mt-5'>
                    <div class='info-box' style='padding: 20px; overflow-x:auto;'>
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                <tr>
                                    <th>Test Name<p></p>HEPATITIS C VIRUS (HCV RAPID)</th>
                                    <th>Result</th>
                                    <th>Unit</th>
                                ...
                                <tr>
                                    <td>HCV (Rapid)</td>
                                    <td>
                                        <select name="hcv" class="form-select form-select-sm" style="font-weight: bold;">
                                            <option value="{{$test->hcv}}" selected>{{$test->hcv}}</option>
