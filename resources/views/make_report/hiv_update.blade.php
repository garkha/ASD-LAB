@extends('layout.asd')
@section('title','HIV I & II SEROLOGY (RAPID)')
@section('head-script')
@endsection
@section('style')
    <style>
                ...
                <div class='row mt-5'>
                    <div class='info-box' style='padding: 20px; overflow-x:auto;'>
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                <tr>
                                    <th>Test Name<p></p>HIV I & II SEROLOGY (RAPID)</th>
                                    <th>Result</th>
                                    <th>Unit</th>
                                ...
                                <tr>
                                    <td>HIV I & II (Rapid)</td>
                                    <td>
                                        <select name="hiv" class="form-select form-select-sm" style="font-weight: bold;">
                                            <option value="{{$test->hiv}}" selected>{{$test->hiv}}</option>
