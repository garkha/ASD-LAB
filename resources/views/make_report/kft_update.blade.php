                        ...
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                ...
                                <tr>
                                    <td>Blood Urea</td>
                                    <td>
                                        <input type="number" step="any" name="Blood_Urea" id="Blood_Urea"  value="{{ $test->Blood_Urea }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="Serum_Creatinine" id="Serum_Creatinine" value="{{ $test->Serum_Creatinine }}">
                                ...
                                <tr>
                                    <td>Uric Acid</td>
                                    <td>
                                        <input type="number" step="any" name="Uric_Acid" id="Uric_Acid" value="{{$test->Uric_Acid}}"> 
                                ...
                                <tr>
                                    <td>Sodium</td>
                                    <td>
                                        <input type="number" step="any" name="Sodium" id="Sodium" value="{{$test->Sodium}}">
                                ...
                                <tr>
                                    <td>Potassium</td>
                                    <td>
                                        <input type="number" step="any" name="Potassium" id="Potassium" value="{{$test->Potassium}}">
                                ...
                                <tr>
                                    <td>Chloride</td>
                                    <td>
                                        <input type="number" step="any" name="Chloride" id="Chloride" value="{{$test->Chloride}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="Blood_Urea_Nitrogen" id="Blood_Urea_Nitrogen" value="{{$test->Blood_Urea_Nitrogen}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="Creatinine_Ratio" id="Creatinine_Ratio" value="{{$test->Creatinine_Ratio}}"/>
