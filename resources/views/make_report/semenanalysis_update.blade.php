                        ...
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                ...
                                <tr>
                                    <td>VOLUME</td>
                                    <td>
                                        <input type="number" step="any" name="VOLUME" id="VOLUME"  value="{{ $test->VOLUME }}" required/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="COLOUR" class="form-select form-select-sm">
                                            <option {{$test->COLOUR}} selected>{{$test->COLOUR}}</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="REACTION" class="form-select form-select-sm">
                                            <option {{$test->REACTION}} selected>{{$test->REACTION}}</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="VISCOCITY" class="form-select form-select-sm">
                                            <option {{$test->VISCOCITY}} selected>{{$test->VISCOCITY}}</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="LIQUEFACTION_TIME" class="form-select form-select-sm">
                                            <option {{$test->LIQUEFACTION_TIME}} selected>{{$test->LIQUEFACTION_TIME}}</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="TOTAL_SPERMCOUNT" id="TOTAL_SPERMCOUNT" value="{{$test->TOTAL_SPERMCOUNT}}" required/>
                                ...
                                <tr>
                                    <td>ACTIVE</td>
                                    <td>
                                        <input type="number" step="any" name="ACTIVE" id="ACTIVE" value="{{$test->ACTIVE}}" required />
                                ...
                                <tr>
                                    <td>SLUGGISH</td>
                                    <td>
                                        <input type="number" step="any" name="SLUGGISH" id="SLUGGISH" value="{{$test->SLUGGISH}}" required />
                                ...
                                <tr>
                                    <td>NON-MOTILE</td>
                                    <td>
                                        <input type="number" step="any" name="NON_MOTILE" id="NON_MOTILE" value="{{$test->NON_MOTILE}}" required />
                                ...
                                <tr>
                                    <td>PUS CELLS</td>
                                    <td>
                                        <input type="number" step="any" name="PUS_CELLS" id="PUS_CELLS" value="{{$test->PUS_CELLS}}" required />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="EPITHELIAL_CELLS" id="EPITHELIAL_CELLS" value="{{$test->EPITHELIAL_CELLS}}" required />
