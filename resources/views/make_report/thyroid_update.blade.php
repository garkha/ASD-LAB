                        ...
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="t3" id="t3" value="{{$test->t3}}">
                                ...
                                <tr>
                                    <td>T4 (Thyroxine)</td>
                                    <td>
                                        <input type="number" step="any" name="t4" id="t4" value="{{$test->t4}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="tsh" id="tsh" value="{{$test->tsh}}">
