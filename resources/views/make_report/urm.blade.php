                        ...
                        <form action='' method='post'>
                            ...
                            <table id='test'>
                                ...
                                <tr>
                                    <td>pH</td>
                                    <td>
                                        <input type="number" step="any" name="pH" id="pH" value="{{ old('pH') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" name="Specific_Gravity" id="Specific_Gravity" value="{{ old('Specific_Gravity') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="Pus_Cells" id="Pus_Cells" value="{{ old('Pus_Cells') }}"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="Epithelial_Cells" id="Epithelial_Cells" value="{{ old('Epithelial_Cells') }}">
                                ...
                                <tr>
                                    <td>Others</td>
                                    <td>
                                        <input type="text" name="Others" value="{{ old('Others') }}" style="font-weight: bold; width:192px;">
